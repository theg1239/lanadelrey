                        ...
                        {step === 0 && (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="mx-auto w-16 h-16 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center glow-amber"
                                >
                                ...
                                <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
                                    {["Transcription", "Entity Extraction", "Intent Analysis", "Compliance"].map((tag) => (
                                        <Badge key={tag} variant="secondary" className="text-xs font-mono px-2 py-0.5">
                                            {tag}
                                        </Badge>
                                    ))}
                                </div>
                                    ...
                                    {useCases.map((uc) => {
                                        ...
                                        return (
                                            <Card
                                                ...
                                                className={`cursor-pointer p-4 transition-all duration-200 ${isSelected
                                            ...
                                            >
                                                <div className="flex items-start gap-3">
                                                    <div
                                                        className={`w-9 h-9 rounded-md flex items-center justify-center shrink-0 transition-colors ${isSelected
                        ...
                        {step === 3 && (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="mx-auto w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center"
                                >
                                ...
                                <a
                                    href="/app"
                                    className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:bg-primary/90 transition-all glow-amber"
                                >
                                    Launch Platform
