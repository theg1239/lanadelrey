...
import { FileAudio, Volume2, Languages, Users, ShieldCheck, Target, Landmark, Scale, AlertTriangle, } from "lucide-react";
const capabilities = [
    {
        icon: FileAudio,
...
export function CapabilityGrid() {
    return (<section className="py-24 sm:py-32 px-6 border-t border-border">
            ...
            const Icon = cap.icon;
            return (<motion.div key={cap.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-30px" }} transition={{ duration: 0.4, delay: (i % 3) * 0.1 }}>
