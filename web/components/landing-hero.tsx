...
// ── Miniature platform preview (embedded in hero) ──────
function PlatformPreview() {
    const bars = useMemo(
        () => Array.from({ length: 28 }, (_, i) => Math.round(4 + seededRandom(i) * 20)),
        [],
    );
...
function HeroWaveform() {
    ...
    return (
        <div className="absolute inset-0 flex items-end justify-center gap-[2px] pb-[35%] opacity-[0.04] pointer-events-none">
            {bars.map((bar, i) => (
                <div
                    key={i}
                    className="hero-wave-bar w-[2px] rounded-full bg-primary"
                    style={{
                        height: `${bar.height}%`,
...
export function LandingHero() {
    return (
        <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden px-6 pt-20 pb-12">
            <HeroWaveform />
            ...
            <div className="relative z-10 w-full max-w-5xl space-y-10">
                ...
                <div className="text-center space-y-5">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] text-foreground text-balance"
                    >
                        Hear what data{" "}
                    ...
                    <motion.p
                        ...
                        className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed font-serif text-balance"
                    >
